...
//	public static final Double3D SPAWN_POS = new Double3D(5, 33, (float)Math.PI / -4);
    ...
    public static final int   DRONE_SIGNAL_MEAN_STEPS 	= 5;    // Number of signal measures we take the mean from
