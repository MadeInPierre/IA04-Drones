...
public class Constants {
    ...
    public static final float N_DRONES = 3;
	...
	public static final float DRONE_COLLISION_SENSOR_WEIGHT 		  = 0.5f;		// Weight of the collision sensor vector for avoiding walls
